  ...
  return (
    <div className="w-full relative z-10 flex flex-col items-center text-center mt-12 md:mt-20 mb-20">
      ...
      <motion.div
        ...
        className="inline-flex items-center gap-2 bg-[#00cdba]/15 text-[#00cdba] border border-[#00cdba]/30 px-5 py-2 rounded-full text-xs font-extrabold tracking-wider uppercase mb-8"
      >
        <span className="w-2 h-2 rounded-full bg-[#00cdba] animate-pulse" />
      ...
      >
        SEL For <span className="inline-block bg-[#00cdba] text-[#111827] px-6 py-2 rounded-[2rem] -rotate-2 shadow-sm ml-2 font-bold">Children</span>
      </motion.h1>
      ...
      <motion.div 
        ...
        className="h-1 bg-[#00cdba]/50 rounded-full mt-8"
      />
    </div>
  );
}
