  ...
  return (
    <div className="w-full relative z-10 flex flex-col items-center text-center mt-12 md:mt-20 mb-20">
      ...
      <motion.div
        ...
        className="inline-flex items-center gap-2 bg-[#ff5c7a]/15 text-[#ff5c7a] border border-[#ff5c7a]/30 px-5 py-2 rounded-full text-xs font-extrabold tracking-wider uppercase mb-8"
      >
      ...
      >
        SEL For <span className="inline-block bg-[#ff5c7a] text-white px-6 py-2 rounded-[2rem] -rotate-2 shadow-sm ml-2 font-bold">Parents</span>
      </motion.h1>
      ...
      <motion.div 
        ...
        className="h-1 bg-[#ff5c7a]/50 rounded-full mt-8"
      />
    </div>
  );
}
