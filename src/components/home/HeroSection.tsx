...
import { Star, ArrowRight, Sparkles, Users } from "lucide-react";
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Three CTAs: membership leads, the other two sit beside it as
              quieter outline pills so one primary action stays obvious. */}
          <div className="mt-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 z-20">
            ...
            <Link
              href="/club"
              className="group inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white border border-[#00CDBA]/30 text-[#00998c] font-bold text-sm hover:bg-[#00CDBA]/5 hover:-translate-y-0.5 transition-all shadow-sm w-max"
            >
              <Users size={16} />
              Explore clubs
              <ArrowRight size={15} className="group-hover:translate-x-1 transition-transform" />
